import getAllInvoices from "./AllInvoices";

export default function invoiceTable(
  invoices: ReturnType<typeof getAllInvoices>,
) {
  return (
      ...
      {invoices.map((invoice) => {
        return (
          <div
            ...
            className="invoice p-8 flex bg-tertiaryContainer  heading flex-col rounded-2xl w-full text-onTertiaryContainer"
          >
            <table>
              <tbody>
                <tr>
